...
// Get client data based on clientId address
...
//modify the first name, last name, and email address of a client based on the client id
function modClient($clientFirstname, $clientLastname, $clientEmail, $clientId){
    $db = phpmotorsConnect();
    // The SQL statement
...
//modify the client password on the clients table based on the client Id
function modPassword($clientPassword, $clientId){
    $db = phpmotorsConnect();
    // The SQL statement
